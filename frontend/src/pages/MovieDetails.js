...
import { FetchMovieDetails, FetchMovieCredits } from '../API/GetMovieDetails';
...
const MovieDetails = () => {
  ...
  // const firstActor = credits.cast.length > 0 ? credits.cast[0].name : 'No cast information';
        ...
        <div className='max-w-5xl mx-auto'>
          <div className='flex flex-wrap justify-center items-start'>
            ...
            <div className='w-full md:w-1/2 lg:w-2/3 px-6 text-left'>
              ...
              <p className='text-gray-800 mt-2 text-sm md:text-sm lg:text-base'>
                <b>Main Actor:</b> {credits.cast.length > 0 ? (
                  <Link to={`/actor/${credits.cast[0].id}`} className="text-blue-500 hover:underline">{credits.cast[0].name}</Link>
                ) : 'No cast information'}
              </p>
              <p className='text-gray-800 mt-2 text-sm md:text-sm lg:text-base'>
